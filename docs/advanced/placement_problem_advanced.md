...
数据集下载链接：[校内链接(ISPD2016-Benchmarks.zip)](http://172.18.233.211:5244/VLSI/VLSI%E8%AF%BE%E7%A8%8B/dataset/placement)和[校外链接（ISPD2016-FPGA Placement Contest）](https://www.ispd.cc/contests/16/ispd2016_contest.html)。

...
实验共设置 3 项独立任务，学生可从划分算法实验、布局算法实验、布线算法实验中**任选一项完成**，具体任务要求如下：
...
| 大作业 | 芯片设计优化 | 基于前面芯片设计实验，根据要求在现有代码基础上做出改进，对比baseline有提高，并撰写实验报告。 |

> Tip0: 大作业的具体要求请看网站的大作业部分
> 
> Tip1: baseline不只是最终结果好坏这一种，也包括算法的速度、加速比、支持新特性等等。你应该在某一个方面有比较突出的地方。
